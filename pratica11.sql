/* pratica11.sql: Planos de Execução
...
explain plan for
create index idx11 on t11(valor);
 ...
 */
 ...
 select /* meu-tag */ id, trunc(valor) from t11;
 ...
 exec dbms_stats.delete_table_stats(user, 'T11');
...
select id, trunc(valor) valor from t11 where rownum < 3;
