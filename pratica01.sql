/* pratica01.sql: Estruturas de Memória
...
/*
  A query acima foi exposta apenas a título de curiosidade. Para o restante 
...
-- Como exercício, você pode unir a v$process com a v$process_memmory para
-- descobrir o nome de cada processo

/*
  Finalmente, temos a v$sql_workarea_histogram. Esta view nos mostra o número
  de workareas executadas com as classificações optimal, one-pass e multi-pass.
 */
...
/*
  ...
  Vamos para a próxima etapa: processos!
 */